...
const GetDescAPIHandler = {
  canHandle(handlerInput) {
    return (
      Alexa.getRequestType(handlerInput.requestEnvelope) === "Dialog.API.Invoked" &&
      handlerInput.requestEnvelope.request.apiRequest.name === "getDesc"
    );
  },
  handle(handlerInput) {
    const recommendationResult =
      handlerInput.requestEnvelope.request.apiRequest.arguments.recommendationResult;
    ...
    console.log("GetDescAPIHandler", JSON.stringify(response));

    return response;
  },
};

const GetPetAPIHandler = {
  canHandle(handlerInput) {
    return (
      Alexa.getRequestType(handlerInput.requestEnvelope) === "Dialog.API.Invoked" &&
      handlerInput.requestEnvelope.request.apiRequest.name === "getPet"
    );
  },
  handle(handlerInput) {
